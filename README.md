...
Để chạy mã nguồn này và với các file Football_object_detector.ipynb và train_pitch_keypoint_detector.ipynb, bạn(thầy) cần lập 1 tài khoản [Roboflow](https://roboflow.com/), lấy Private_API_KEY của tài khoản ([tại đây](https://app.roboflow.com/mycv-ybicf/settings/api)) và thay vào file .env (tự tạo) theo dạng 'ROBOFLOW_API_KEY=VcXIxxxxxxxjjqp' để pull mô hình nhóm đã 'deploy' lên Roboflow về.
